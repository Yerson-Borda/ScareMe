...
fun AppNavigation() {
    ...
    NavHost(navController = navController, startDestination = AppScreens.SplashScreen.route) {
        addBasicRoutes(navController)
        addMessengerRoute(navController)
    }
}

private fun NavGraphBuilder.addBasicRoutes(navController: NavController) {
    ...
    composable(AppScreens.SignIn.route) { SignInScreen(navController) }
    composable(AppScreens.SignUp.route) { SignUpScreen(navController) }
    composable(AppScreens.Registration.route) { UserInfo(navController) }
    composable(AppScreens.Cards.route) { Main(navController) }
    composable(AppScreens.Chat.route) { ChatScreen(navController) }
    composable(AppScreens.Profile.route) { ProfileScreen(navController) }
    composable(AppScreens.MyProfile.route) { MyProfileScreen(navController) }
}

private fun NavGraphBuilder.addMessengerRoute(navController: NavController) {
    composable(
